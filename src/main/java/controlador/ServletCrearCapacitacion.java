...
public class ServletCrearCapacitacion extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		cap.setRutCap(Integer.parseInt(request.getParameter("rutCliente")));
		cap.setDiaCap(request.getParameter("diaSemana"));
		...
		cap.setnAsistentes(Integer.parseInt(request.getParameter("nAsistentes")));
